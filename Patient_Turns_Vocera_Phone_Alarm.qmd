...
Furthermore, a t-test noted no significant difference, regarding the Braden Scale scores and type of events @tab-Ttest_Chisq_Table. 
...
```{r}
#| label: NURSE DATA ANALYSIS PT.2
#| include: false
...
```{r}
#| label: NURSE DATA ANALYSIS PLOTS pt. 2
#| include: false
...
```{r}
#| label: Patient Analysis Plot pt 2
#| include: false
## Event type and lOS
...
```{r}
#| label: T test for Los and Type of event
#| include: false
...
```{r}
#| label: tab-Ttest_Chisq_Table
#| echo: false
#| tab-cap: Ttest_Chisq_Table
